...
public class VectorOperation<Key> {
	...
	public double pearson(HashMap<Key, Double> vector1, HashMap<Key, Double> vector2) {
		HashMap<Key, Double> newVector1 = (HashMap<Key, Double>) vector1.clone(); 
		HashMap<Key, Double> newVector2 = (HashMap<Key, Double>) vector2.clone(); 
		double avg1=0,avg2=0;
		for(double value:newVector1.values()){
			avg1+=value;
		}
		return cosine(newVector1, newVector2);
	}
}